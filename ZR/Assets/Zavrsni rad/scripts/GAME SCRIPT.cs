...
public class GAMESCRIPT : MonoBehaviour
{
    ...
    IEnumerator Task12()
    {
        float elapsedTime = Time.time - task1StartTime;
        Debug.Log("Charlie Time: " + elapsedTime + " seconds");
        WriteElapsedTime("CharlieTime: " + elapsedTime + " seconds\n");
    ...
    {
        float elapsedTime = Time.time - task1StartTime;
        Debug.Log("Remy Time: " + elapsedTime + " seconds");
        WriteElapsedTime("RemyTime: " + elapsedTime + " seconds\n");
    ...
    {
        float elapsedTime = Time.time - task1StartTime;
        Debug.Log("Elsa Time: " + elapsedTime + " seconds");
        WriteElapsedTime("ElsaTime: " + elapsedTime + " seconds\n");
